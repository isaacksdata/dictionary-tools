...
from dict_tools.utils import sort_mixed_list
...
class DictionaryParser:
    """
    This is a class for parsing a dictionary and returning a string of its dict_tools which can be printed for a
    convenient way of understanding any nested dict_tools and the types used
    ...
    def gtn_with_variable(self, obj: Any) -> str:
        ...
        if isinstance(obj, CommentedValue):
            ...
            if isinstance(obj, (tuple, list)):
                items: Union[Tuple[Any, ...], List[Any]] = (
    ...
    def getStructure_list(
        ...
        """
        Get the dict_tools of a list element. The response will include a list of all the types contained within the
